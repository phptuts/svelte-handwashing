var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="how_to_handwash.gif" alt="hand washing" class="svelte-1p471kh">`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			t1 = text("% Complete");
    			attr(span, "class", "sr-only svelte-g87qrr");
    			attr(div0, "class", "progress-bar svelte-g87qrr");
    			attr(div0, "role", "progressbar");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "class", "progress-container svelte-g87qrr");
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*secondsLeft*/ 1) {
    			 $$invalidate(2, progress = (20 - secondsLeft) / 20 * 100);
    		}
    	};
    ...
    function create_fragment$3(ctx) {
    	...
    	timer.$on("play", /*play*/ ctx[1]);
    	const howto = new HowTO({});

    	return {
    		c() {
    			div0 = element("div");
    			div0.innerHTML = `<h1 bp="12" class="svelte-1wdv9cp">Hand Washing App</h1>`;
    			t1 = space();
    			...
    			div1.innerHTML = `<h3 bp="offset-5@md 4@md 12@sm"><a href="https://www.who.int/gpsc/clean_hands_protection/en/">
      Picture Source
    </a> 
    <a href="https://freesound.org/people/metrostock99/sounds/345086/">
      Sound Attribution
    			...
    			t7 = space();
    			audio = element("audio");
    			audio.innerHTML = `<source src="sound.wav" type="audio/wav">`;
    			attr(div0, "bp", "grid");
    			attr(div1, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function audio_binding($$value) {
    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			$$invalidate(0, sound = $$value);
    		});
    	}

    	return [sound, play, audio_binding];
    }
